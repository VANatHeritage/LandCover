...
# folder that are used directly as environmental
# variables for SDM work.
...
# Data Links:
# latest Virginia NLCD clips are in the AGOL group:
...
yrs = ['2001', '2004', '2006', '2008', '2011', '2013', '2016']
yrs = ['2001', '2006', '2011', '2016']
...
for yr in yrs:
   ...
   # input raster(s). leave None for ones not used
   nlcd_classified = r'L:\David\GIS_data\NLCD\nlcd_2016\nlcd_2016ed_LandCover_albers.gdb\lc_' + yr
   impervious_raster = r'L:\David\GIS_data\NLCD\nlcd_2016\nlcd_2016ed_Impervious_albers.gdb\imperv_' + yr
   if not arcpy.Exists(impervious_raster):
      impervious_raster = None
   canopy_raster = None
   ...
   remap_wetland = RemapValue(
      [[11, 0], [12, 0], [21, 0], [22, 0], [23, 0], [24, 0], [31, 0], [41, 0], [42, 0], [43, 0], [52, 0], [71, 0],
       [81, 0],
       [82, 0], [90, 1], [95, 1]])

   # For Open Area we want 31, 71,81,82
   remap_Open = RemapValue(
      [[11, 0], [12, 0], [21, 0], [22, 0], [23, 0], [24, 0], [31, 1], [41, 0], [42, 0], [43, 0], [52, 0], [71, 1],
       [81, 1],
       [82, 1], [90, 0], [95, 0]])

   # For Water we want 11
   remap_water = RemapValue(
      [[11, 1], [12, 0], [21, 0], [22, 0], [23, 0], [24, 0], [31, 0], [41, 0], [42, 0], [43, 0], [52, 0], [71, 0],
       [81, 0],
       [82, 0], [90, 0], [95, 0]])

   # For ShrubScrub we want 52
   remap_ShrubScrub = RemapValue(
      [[11, 0], [12, 0], [21, 0], [22, 0], [23, 0], [24, 0], [31, 0], [41, 0], [42, 0], [43, 0], [52, 1], [71, 0],
       [81, 0],
       [82, 0], [90, 0], [95, 0]])
